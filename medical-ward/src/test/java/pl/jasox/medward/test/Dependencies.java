...
public interface Dependencies {
  ...
  static final Archive<?>[] SOLDER = DependencyResolvers.use(MavenDependencyResolver.class)
  ...
  static final Archive<?>[] JODA_TIME = DependencyResolvers.use(MavenDependencyResolver.class)
