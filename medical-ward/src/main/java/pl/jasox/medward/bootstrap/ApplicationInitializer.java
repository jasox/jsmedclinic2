 ...
 */
package pl.jasox.medward.bootstrap;
...
/**
 * An alternative bean used to import seed data into the database when
 * the application is being initialized.
 *
 * @author <a href="mailto:lincolnbaxter@gmail.com">Lincoln Baxter, III</a>
 * @author <a href="http://community.jboss.org/people/dan.j.allen">Dan Allen</a>
 */
// @Stateless // can't use EJB since they are not yet available 
//               for lookup when initialized event is fired
@Alternative
public class ApplicationInitializer {
  ...
  /**
   * Import seed data when Seam Servlet fires an event notifying
   * observers that the web application is being initialized.
   */
